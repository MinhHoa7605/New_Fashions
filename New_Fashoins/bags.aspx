<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bags.aspx.cs" Inherits="New_Fashoins.bags" %>
		 ...
		 <div class="col-md-9 product-model-sec">
					 <a href="single.aspx"><div class="product-grid love-grid">
						...
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/Hinh/t1.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>Túi Bucket (hồng)</h4>
								<span class="item_price">169.000 VND</span>
					 ...
					 <a href="single.aspx"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/Hinh/t2.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button class="btns">ĐẶT HÀNG NGAY</button>
							</h4>
					...
					<a href="single.aspx"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/Hinh/t3.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button class="btns">ĐẶT HÀNG NGAY</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>Túi đeo chéo (xanh)</h4>
								<span class="item_price">129.000 VND</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="THÊM">	
							</div>											
							<div class="clearfix"> </div>
					...
					<a href="single.aspx"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/Hinh/t4.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button class="btns">ĐẶT HÀNG NGAY</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>Ba lô nhỏ (bạc)</h4>
								<span class="item_price">259.000 VND</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="THÊM">
							</div>												
							<div class="clearfix"> </div>
					...
					<a href="single.aspx"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/Hinh/t5.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button class="btns">ĐẶT HÀNG NGAY</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4>Túi đeo chéo xám</h4>
								<span class="item_price">215.000 VND</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="THÊM">
							</div>												
							<div class="clearfix"> </div>
					...
					<a href="single.aspx"><div class="product-grid love-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/Hinh/t6.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button class="btns">ĐẶT HÀNG NGAY</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust">
								<h4 class="love-info">Túi đeo chéo (đỏ)</h4>
								<span class="item_price">215.000 VND</span>
								<input type="text" class="item_quantity" value="1" />
								<input type="button" class="item_add items" value="THÊM">	
							</div>										
...
<div class="fotter-logo">
	 ...
	 <div class="ftr-info">
	 <p>&copy; 2019 Thiết kế bởi <a href="http://facebook.com/minhhoa2013" target="_blank">Minh Hòa</a> </p>
	</div>
	 <div class="clearfix"></div>
	 </div>
</div>
