<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="New_Fashoins.cart" %>
		 ...
		 <ul class="megamenu skyblue">
			<li><a href="index.aspx">TRANG CHỦ</a></li>							
			 <li><a href="#">PHỤ NỮ</a>
				...
				<li class="active"><a href="bags.aspx">PHỤ KIỆN & TÚI</a>
				<div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
...
<div class="cart">
	 <div class="container">
			 <ol class="breadcrumb">
		  <li><a href="men.aspx">Trang chủ</a></li>
